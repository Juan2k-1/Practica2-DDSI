...
public class ControladorPrincipal implements ActionListener {
    ...
    /**
     * Este metodo es el constructor de la clase Controlador principal
     * Se encarga de inicializar los atributos y de crear las vistas de los mensajes relacionados con la ventana principal y la propia ventana principal
     * 
     * @param conexion  
     */
     ...
     * En este caso solo trata el evento de pulsar el botón de cerrar la ventana principal recogido por el addListeners()
     ...
     * En este caso simplemente está a la escucha de que pulsemos el botón de salir de la ventana
     */
    private void addListeners() {
        vPrincipal.jButtonExitPrincipal.addActionListener(this);
    }
}
